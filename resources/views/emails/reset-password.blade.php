...
<head>
    ...
    <style>
        ...
        .header { background-color: #FF5722; padding: 20px; text-align: center; color: white; border-radius: 8px 8px 0 0; }
        .content { background-color: #fff; padding: 30px; border: 1px solid #ddd; border-radius: 0 0 8px 8px; }
        .button { display: inline-block; background-color: #FF5722; color: white; padding: 12px 24px; text-decoration: none; border-radius: 4px; font-weight: bold; margin: 20px 0; }
...
<body>
    <div class="container">
        ...
        <div class="footer">
            <p>© {{ date('Y') }} Bookphoria. All rights reserved.</p>
