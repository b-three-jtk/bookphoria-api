    ...
    <div class="flex grow flex-col items-center justify-between lg:flex-row lg:px-6">
        <div
            ...
            <a href="index.html" class="lg:hidden">
                <img class="dark:hidden" src="{{ asset('images/shape/logo.png') }}" alt="Logo" />
            ...
            <div class="relative" x-data="{ dropdownOpen: false }" @click.outside="dropdownOpen = false">
                <a class="flex items-center text-gray-700 dark:text-gray-400" href="#"
                    ...
                    <span class="mr-3 h-11 w-11 overflow-hidden rounded-full">
                        <img src="{{ auth()->user()->avatar ?? './images/user/owner.jpg' }}" alt="User" />
                    </span>

                    <span class="text-theme-sm mr-1 block font-medium"> {{ auth()->user()->first_name ?? 'Super Admin' }} </span>
                ...
                <div x-show="dropdownOpen"
                    ...
                    <div>
                        <span class="text-theme-sm block font-medium text-gray-700 dark:text-gray-400">
                            {{ auth()->user()->first_name . ' ' . auth()->user()->last_name ?? 'Super Admin' }}
                        </span>
                        <span class="text-theme-xs mt-0.5 block text-gray-500 dark:text-gray-400">
                            {{ auth()->user()->email ?? 'superadmin@bookphoria.com' }}
                        </span>
                    </div>
